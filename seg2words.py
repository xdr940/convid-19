...
parser.add_argument('--doc',default='./doc6.txt')
parser.add_argument('--seged_doc',default='./seged_doc.txt')
...
def infer_graph_table(args):
    ...
    for line in lines:
        row_classes.append(line[:2])
        row_contents.append(line[2:])
