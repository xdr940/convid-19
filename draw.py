...
parser.add_argument('--node_file',default='.data/array.txt',help='output an txt to descripe file_in')
parser.add_argument('--edge-file',default='.data/seqsubseq.txt')
parser.add_argument('--graph_tab',default='./data/graph_tab.txt')
parser.add_argument('--leaf_dict',default='.data/leaf_dict.txt')
parser.add_argument('--node_dict',default='.data/node_dict.txt')
parser.add_argument('--graph_tab_csv',default='./data/graph_tab_6.csv')
parser.add_argument('--graph_tab_sta',default='./data/graph_tab_sta_6.csv')
